...
CREATE TABLE `goods_cart_item`  (
  ...
  `GoodsId` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '产品id',
...
CREATE TABLE `orderdetail`  (
  ...
  `GoodsId` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产品编号',
  `GoodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产品名称',
  `Num` int(11) NOT NULL COMMENT '购买数量',
  `GoodsImage` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产品图片',
...
CREATE TABLE `orderinfo`  (
  ...
  `GoodsNo` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品编号',
  `GoodsName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称（组合名称）',
  ...
  `GoodsSpecId` int(11) NOT NULL DEFAULT 0 COMMENT '产品规格Id',
  `GoodsSpecName` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品规格名称',
...
CREATE TABLE `petgoods`  (
  ...
  `GoodsImage` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品图片',
...
) ENGINE = InnoDB AUTO_INCREMENT = 308 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品信息表' ROW_FORMAT = Dynamic;
